...
After deploying the worker, set the GitHub Actions **repository variable** `VITE_CONTRIBUTE_API_URL` to the worker origin (for example `https://wlcd-contribute.<account>.workers.dev`). Locally:
